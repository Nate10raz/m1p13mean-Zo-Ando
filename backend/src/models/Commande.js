...
const commandeSchema = new mongoose.Schema({
    ...
    boutiques: [{
        ...
        items: [{
            ...
            nomProduit: String,
            imageProduit: String,
            couponOrPromotionsUtiliseIds: [{ type: mongoose.Schema.Types.ObjectId, ref: "CouponOrPromotion" }]
        }],

        status: {
            type: String,
            enum: ["en_preparation", "peut_etre_collecte", "annulee", "en_attente_validation", "non_acceptee"],
            required: true,
            index: true
        }
    }],
    ...
    statusLivraison: {
        type: String,
        enum: ["pret_a_collecte", "en_preparation", "peut_etre_collecte", "en_livraison", "annulee", "en_attente_validation", "non_acceptee"],
        required: true,
        index: true
    }
});
